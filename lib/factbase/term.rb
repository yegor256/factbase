...
class Factbase::Term < Factbase::TermBase
  ...
  TERMS = {
    unique: Factbase::Unique,
    prev: Factbase::Prev,
    concat: Factbase::Concat,
    sprintf: Factbase::Sprintf,
    matches: Factbase::Matches,
    contains: Factbase::Contains,
    starts_with: Factbase::StartsWith,
    ends_with: Factbase::EndsWith,
    traced: Factbase::Traced,
    assert: Factbase::Assert,
    env: Factbase::Env,
    defn: Factbase::Defn,
    undef: Factbase::Undef,
    as: Factbase::As,
    join: Factbase::Join,
    exists: Factbase::Exists,
    absent: Factbase::Absent,
    size: Factbase::Size,
    type: Factbase::Type,
    nil: Factbase::Nil,
    many: Factbase::Many,
    one: Factbase::One,
    to_string: Factbase::ToString,
    to_integer: Factbase::ToInteger,
    to_float: Factbase::ToFloat,
    to_time: Factbase::ToTime,
    sorted: Factbase::Sorted,
    inverted: Factbase::Inverted,
    head: Factbase::Head,
    plus: Factbase::Plus,
    minus: Factbase::Minus,
    times: Factbase::Times,
    div: Factbase::Div,
    zero: Factbase::Zero,
    eq: Factbase::Eq,
    lt: Factbase::Lt,
    ...
    gt: Factbase::Gt,
    gte: Factbase::Gte,
    always: Factbase::Always,
    never: Factbase::Never,
    not: Factbase::Not,
    or: Factbase::Or,
    and: Factbase::And,
    when: Factbase::When,
    either: Factbase::Either,
    count: Factbase::Count,
    first: Factbase::First,
    nth: Factbase::Nth,
    sum: Factbase::Sum,
    agg: Factbase::Agg,
    empty: Factbase::Empty,
    min: Factbase::Min,
    max: Factbase::Max
  }.freeze
  ...
  def term
    @term ||= TERMS[@op].new(@operands).tap { |t| t.name = @op }
  end
