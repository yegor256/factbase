...
```text
                                                                   user
insert 20000 facts                                             0.627878
export 20000 facts                                             0.024799
import 410665 bytes (20000 facts)                              0.023069
insert 10 facts                                                0.042135
query 10 times w/txn                                           2.037882
query 10 times w/o txn                                         0.040756
modify 10 attrs w/txn                                          1.751613
delete 10 facts w/txn                                          1.010321
(and (eq what 'issue-was-closed') (exists... -> 200            2.131666
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.136317
(and (eq what 'issue-was-closed') (exists... -> zero           2.442950
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.298094
(gt time '2024-03-23T03:21:43Z')                               0.334228
(gt cost 50)                                                   0.253275
(eq title 'Object Thinking 5000')                              0.085948
(and (eq foo 42.998) (or (gt bar 200) (absent zzz)))           0.415612
(and (exists foo) (not (exists blue)))                         0.912237
(eq id (agg (always) (max id)))                                0.731272
(join "c<=cost,b<=bar" (eq id (agg (always) (max id))))        1.566471
delete!                                                        0.158988
Taped.append() x50000                                          0.022215
Taped.each() x125                                              1.353015
Taped.delete_if() x375                                         0.859769
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-07-14 at 08:50,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/16262362308
