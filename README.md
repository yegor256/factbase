...
import 410962 bytes (20000 facts)                                  0.03
insert 10 facts                                                    0.04
query 10 times w/txn                                               2.19
query 10 times w/o txn                                             0.07
modify 10 attrs w/txn                                              1.95
delete 10 facts w/txn                                              0.91
(and (eq what 'issue-was-closed') (exists... -> 200                1.22
(and (eq what 'issue-was-closed') (exists... -> 200/txn            1.28
(and (eq what 'issue-was-closed') (exists... -> zero               1.23
(and (eq what 'issue-was-closed') (exists... -> zero/txn           1.26
transaction rollback on factbase with 100000 facts                 0.20
(gt time '2024-03-23T03:21:43Z')                                   0.32
(gt cost 50)                                                       0.17
(eq title 'Object Thinking 5000')                                  0.04
(and (eq foo 42.998) (or (gt bar 200) (absent z...                 0.05
(and (exists foo) (not (exists blue)))                             1.60
(eq id (agg (always) (max id)))                                    2.63
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...                 3.87
(and (eq what "foo") (join "w<=what" (and (eq i...                 7.67
delete!                                                            0.53
(and (eq issue *) (eq repository *) (eq what '*') (eq where '*')) 26.94
...
on 2025-11-23 at 04:53,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/19606120937
