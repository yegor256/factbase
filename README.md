...
```text
                                                                   user
insert 20000 facts                                             0.594590
export 20000 facts                                             0.019969
import 411060 bytes (20000 facts)                              0.029198
insert 10 facts                                                0.038013
query 10 times w/txn                                           1.806226
query 10 times w/o txn                                         0.038587
modify 10 attrs w/txn                                          1.656482
delete 10 facts w/txn                                          0.984821
(and (eq what 'issue-was-closed') (exists... -> 200            2.167345
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.164740
(and (eq what 'issue-was-closed') (exists... -> zero           2.488333
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.313003
(gt time '2024-03-23T03:21:43Z')                               0.104540
(gt cost 50)                                                   0.088488
(eq title 'Object Thinking 5000')                              0.002651
(and (eq foo 42.998) (or (gt bar 200) (absent zzz)))           0.203045
(eq id (agg (always) (max id)))                                0.240596
(join "c<=cost,b<=bar" (eq id (agg (always) (max id))))        0.633015
delete!                                                        0.073122
Taped.append() x50000                                          0.035862
Taped.each() x125                                              1.339905
Taped.delete_if() x375                                         0.807802
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-06-09 at 14:13,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/15536639161
