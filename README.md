...
import 410856 bytes (20000 facts)                                  0.03
insert 10 facts                                                    0.04
query 10 times w/txn                                               2.32
query 10 times w/o txn                                             0.07
modify 10 attrs w/txn                                              1.95
delete 10 facts w/txn                                              0.92
...
(and (eq what 'issue-was-closed') (exists... -> 200                1.25
(and (eq what 'issue-was-closed') (exists... -> 200/txn            1.29
(and (eq what 'issue-was-closed') (exists... -> zero               1.24
...
(and (exists foo) (not (exists blue)))                             1.70
(eq id (agg (always) (max id)))                                    2.76
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...                 4.02
(and (eq what "foo") (join "w<=what" (and (eq i...                 7.74
delete!                                                            0.56
(and (eq issue *) (eq repository *) (eq what '*') (eq where '*')) 28.03
...
on 2025-11-29 at 03:25,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/19778272453
