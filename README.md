...
```text
                                                                   user
insert 20000 facts                                             0.630398
export 20000 facts                                             0.022890
import 410965 bytes (20000 facts)                              0.024301
insert 10 facts                                                0.043471
query 10 times w/txn                                           2.414878
query 10 times w/o txn                                         0.048699
modify 10 attrs w/txn                                          2.182964
delete 10 facts w/txn                                          1.156030
(and (eq what 'issue-was-closed') (exists... -> 200            1.211432
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.175660
(and (eq what 'issue-was-closed') (exists... -> zero           1.158910
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.222634
(gt time '2024-03-23T03:21:43Z')                               0.385800
(gt cost 50)                                                   0.196642
(eq title 'Object Thinking 5000')                              0.102139
(and (eq foo 42.998) (or (gt bar 200) (absent z...             0.051726
(and (exists foo) (not (exists blue)))                         0.941463
(eq id (agg (always) (max id)))                                0.658868
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...             1.382259
(and (eq what "foo") (join "w<=what" (and (eq i...             7.120027
delete!                                                        0.186713
Taped.append() x50000                                          0.025765
Taped.each() x125                                              1.439031
Taped.delete_if() x375                                         0.824102
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-08-28 at 18:52,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/17305137126
