...
```text
                                                                   user
void scan                                                      0.000995
20k facts: export: 2975KB                                      0.793806
20k facts: import: 2975KB                                      1.029822
50k facts: read                                                0.000135
50k facts: read in txn                                         0.002368
50k facts: insert                                              0.000078
50k facts: insert in txn                                       0.000219
50k facts: modify                                              1.121672
50k facts: modify in txn                                       2.970495
12k facts: large query: match 3k                              12.502714
12k facts: large query: match 3k in txn                       18.063667
12k facts: large query: match zero                            13.206355
12k facts: large query: match zero in txn                     18.897210
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-08-07 at 03:42,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/31145040822
