...
```text
                                                                   user
insert 20000 facts                                             0.590095
export 20000 facts                                             0.021837
import 410920 bytes (20000 facts)                              0.024037
insert 10 facts                                                0.036660
query 10 times w/txn                                           1.743140
query 10 times w/o txn                                         0.041195
modify 10 attrs w/txn                                          1.668599
delete 10 facts w/txn                                          0.975847
(and (eq what 'issue-was-closed') (exists... -> 200            2.094689
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.119896
(and (eq what 'issue-was-closed') (exists... -> zero           2.390792
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.271053
(gt time '2024-03-23T03:21:43Z')                               0.335972
(gt cost 50)                                                   0.239617
(eq title 'Object Thinking 5000')                              0.087832
(and (eq foo 42.998) (or (gt bar 200) (absent zzz)))           0.402863
(and (exists foo) (not (exists blue)))                         0.884530
(eq id (agg (always) (max id)))                                0.645073
(join "c<=cost,b<=bar" (eq id (agg (always) (max id))))        1.565177
delete!                                                        0.155193
Taped.append() x50000                                          0.023444
Taped.each() x125                                              1.371085
Taped.delete_if() x375                                         0.831678
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-07-04 at 05:47,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/16066774159
