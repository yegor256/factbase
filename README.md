...
```text
                                                                   user
insert 20000 facts                                             0.584051
export 20000 facts                                             0.019312
import 410506 bytes (20000 facts)                              0.020074
insert 10 facts                                                0.036461
query 10 times w/txn                                           1.905004
query 10 times w/o txn                                         0.046897
modify 10 attrs w/txn                                          1.847831
delete 10 facts w/txn                                          1.077967
(and (eq what 'issue-was-closed') (exists... -> 200            1.105612
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.096020
(and (eq what 'issue-was-closed') (exists... -> zero           1.095830
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.125346
(gt time '2024-03-23T03:21:43Z')                               0.308083
(gt cost 50)                                                   0.182500
(eq title 'Object Thinking 5000')                              0.042453
(and (eq foo 42.998) (or (gt bar 200) (absent z...             0.048753
(and (exists foo) (not (exists blue)))                         0.890213
(eq id (agg (always) (max id)))                                0.599489
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...             1.303611
(and (eq what "foo") (join "w<=what" (and (eq i...             6.884019
delete!                                                        0.211580
Taped.append() x50000                                          0.022314
Taped.each() x125                                              1.364466
Taped.delete_if() x375                                         0.805972
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-27 at 17:07,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/18062581217
