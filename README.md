...
```text
                                                                   user
void scan                                                      0.001136
20k facts: export: 2972KB                                      0.973337
20k facts: import: 2972KB                                      1.147325
50k facts: read                                                0.000293
50k facts: read in txn                                         0.003116
50k facts: insert                                              0.000098
50k facts: insert in txn                                       0.000756
50k facts: modify                                              1.714737
50k facts: modify in txn                                       3.304375
12k facts: large query: match 3k                              15.442148
12k facts: large query: match 3k in txn                       22.960633
12k facts: large query: match zero                            16.149244
12k facts: large query: match zero in txn                     24.077316
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-07-02 at 11:47,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/28587398928
