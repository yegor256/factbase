...
```text
                                                                   user
insert 20000 facts                                             0.586373
export 20000 facts                                             0.018003
import 411207 bytes (20000 facts)                              0.018548
insert 10 facts                                                0.038794
query 10 times w/txn                                           2.015879
query 10 times w/o txn                                         0.045563
modify 10 attrs w/txn                                          1.857615
delete 10 facts w/txn                                          1.041171
(and (eq what 'issue-was-closed') (exists... -> 200            1.122600
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.075456
(and (eq what 'issue-was-closed') (exists... -> zero           1.066996
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.101856
(gt time '2024-03-23T03:21:43Z')                               0.352616
(gt cost 50)                                                   0.175975
(eq title 'Object Thinking 5000')                              0.087996
(and (eq foo 42.998) (or (gt bar 200) (absent z...             0.048325
(and (exists foo) (not (exists blue)))                         0.878764
(eq id (agg (always) (max id)))                                0.619779
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...             1.165077
(and (eq what "foo") (join "w<=what" (and (eq i...             6.825774
delete!                                                        0.293226
Taped.append() x50000                                          0.019193
Taped.each() x125                                              1.411124
Taped.delete_if() x375                                         0.812598
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-10-04 at 16:58,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/18247046113
