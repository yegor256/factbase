...
```text
                                                                   user
void scan                                                      0.001699
20k facts: export: 2971KB                                      0.754658
20k facts: import: 2971KB                                      0.953982
50k facts: read                                                0.000432
50k facts: read in txn                                         0.003047
50k facts: insert                                              0.000084
50k facts: insert in txn                                       0.000216
50k facts: modify                                              1.447454
50k facts: modify in txn                                       2.799619
12k facts: large query: match 3k                              15.190581
12k facts: large query: match 3k in txn                       20.896611
12k facts: large query: match zero                            16.333431
12k facts: large query: match zero in txn                     22.177630
```

The results were calculated in [this GHA job][benchmark-gha]
on 2026-09-26 at 06:40,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/36224094117
