...
insert 500 facts                                               0.014795   0.000000   0.014795 (  0.014792)
export 500 facts                                               0.000602   0.000000   0.000602 (  0.000603)
import 10500 bytes (500 facts)                                 0.000694   0.000024   0.000718 (  0.000720)
insert 10 facts                                                0.002434   0.000000   0.002434 (  0.002437)
query 10 times w/txn                                           0.053620   0.000999   0.054619 (  0.054621)
query 10 times w/o txn                                         0.013991   0.000995   0.014986 (  0.014989)
modify 10 attrs w/txn                                          0.038833   0.000000   0.038833 (  0.038846)
delete 10 facts w/txn                                          0.012256   0.000005   0.012261 (  0.012264)
(and (eq what 'issue-was-closed') (exists... -> 200            7.285934   0.009999   7.295933 (  7.296661)
(and (eq what 'issue-was-closed') (exists... -> 200/txn        8.099733   0.014992   8.114725 (  8.115161)
(and (eq what 'issue-was-closed') (exists... -> zero           9.098101   0.014997   9.113098 (  9.113703)
(and (eq what 'issue-was-closed') (exists... -> zero/txn      10.040534   0.026999  10.067533 ( 10.068275)
(gt time '2024-03-23T03:21:43Z')                               0.023448   0.000002   0.023450 (  0.023449)
(gt cost 50)                                                   0.015372   0.000000   0.015372 (  0.015373)
(eq title 'Object Thinking 5000')                              0.007791   0.000000   0.007791 (  0.007792)
(and (eq foo 42.998) (or (gt bar 200) (absent zzz)))           0.011580   0.000000   0.011580 (  0.011581)
(eq id (agg (always) (max id)))                                0.028969   0.000000   0.028969 (  0.028971)
(join "c<=cost,b<=bar" (eq id (agg (always) (max id))))        0.135475   0.000000   0.135475 (  0.135479)
delete!                                                        0.003525   0.000000   0.003525 (  0.003526)
Taped.append() x50000                                          0.038570   0.005998   0.044568 (  0.044587)
Taped.each() x125                                              1.304061   0.004000   1.308061 (  1.308092)
Taped.delete_if() x375                                         0.821786   0.000000   0.821786 (  0.821811)
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-03-07 at 14:15,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/13722496936
