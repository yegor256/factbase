...
```text
                                                                   user
insert 20000 facts                                             0.604093
export 20000 facts                                             0.020097
import 410848 bytes (20000 facts)                              0.022880
insert 10 facts                                                0.037185
query 10 times w/txn                                           2.003495
query 10 times w/o txn                                         0.043666
modify 10 attrs w/txn                                          1.908760
delete 10 facts w/txn                                          1.025379
(and (eq what 'issue-was-closed') (exists... -> 200            1.108750
(and (eq what 'issue-was-closed') (exists... -> 200/txn        1.079500
(and (eq what 'issue-was-closed') (exists... -> zero           1.074364
(and (eq what 'issue-was-closed') (exists... -> zero/txn       1.161923
(gt time '2024-03-23T03:21:43Z')                               0.373712
(gt cost 50)                                                   0.185637
(eq title 'Object Thinking 5000')                              0.107188
(and (eq foo 42.998) (or (gt bar 200) (absent z...             0.050314
(and (exists foo) (not (exists blue)))                         0.933620
(eq id (agg (always) (max id)))                                0.639990
(join "c<=cost,b<=bar" (eq id (agg (always) (ma...             1.175401
(and (eq what "foo") (join "w<=what" (and (eq i...             7.163907
delete!                                                        0.171652
Taped.append() x50000                                          0.022012
Taped.each() x125                                              1.435427
Taped.delete_if() x375                                         0.818011
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-09-06 at 09:14,
on Linux with 4 CPUs.
<!-- benchmark_end -->

[benchmark-gha]: https://github.com/yegor256/factbase/actions/runs/17512679546
