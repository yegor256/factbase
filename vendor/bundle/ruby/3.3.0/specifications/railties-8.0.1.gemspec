...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v8.0.1/railties/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v8.0.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v8.0.1/railties" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, ["= 8.0.1".freeze])
  ...
  s.add_development_dependency(%q<actionview>.freeze, ["= 8.0.1".freeze])
end
